...
{{--        {{ route('for-organizers.store') }}--}}
        <form action="" class="form for-organizers__form" method="post">
            <div class="form__content">
                ...
                <div class="form__input-block">
                    ...
                    <select name="type" id="type" class="input form__input" required>
                        ...
                        <option value="fiz">Физическое лицо (самозанятый)</option>
                ...
                <div class="form__organizers-section" id="fiz">
                    <div class="form__input-block">
                        <div class="form__label-block">
                            <label for="fiz_phone" class="form__label">Телефон</label>
                        </div>
                        <input type="text" name="fiz_phone" id="fiz_phone" class="input form__input" />
                    </div>
                    <div class="form__input-block">
                        <div class="form__label-block">
                            <label for="fiz_inn" class="form__label">ИНН</label>
                        </div>
                    ...
                    <div class="form__input-block">
                        ...
                        <input type="date" name="date_birth" id="date_birth" class="input form__input" />
                    </div>
                </div>
                <div class="form__organizers-section" id="ur">
                    <div class="form__input-block">
                        ...
                        <input type="text" name="name" id="name" class="input form__input" required />
                    </div>
                    <div class="form__input-block">
                        <div class="form__label-block">
                            <label for="ur_inn" class="form__label">ИНН</label>
                        </div>
